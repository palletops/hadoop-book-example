...
lein do with-profile +palletops clean, with-profile +palletops,+no-checkouts test && \
...
&& lein do with-profile +palletops clean, with-profile +palletops,+no-checkouts test, with-profile +palletops deploy palletops \
